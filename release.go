...
const (
	linuxArtifact  string = "./out/linux/kismatic.tar.gz"
	darwinArtifact string = "./out/darwin/kismatic.tar.gz"
)
...
func main() {
	...
	url := "https://api.github.com/repos/alexbrand/release-test/releases"
	createBody := struct {
